...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "atl_fnc_recompile") then {atl_recompiles = []; atl_fnc_recompile = {{call _x} forEach atl_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; atl_recompiles pushBack _recomp;
#else
